...
for i in range(100):
    ...
    regressor = SVR(kernel='rbf',C=15,gamma=0.01)
...
print('\nSROCC score for X1 is = ', np.median(srocc_X1))
...
print('\nSROCC score for Y1 is = ', np.median(srocc_Y1))
...
median_srocc[2] = np.median(srocc_Z1)
median_pcc[2] = np.median(pcc_Z1)
median_kcc[2] = np.median(kcc_Z1)
median_rmse[2] = np.median(rmse_Z1)
print('\nSROCC score for Z1 is = ', np.median(srocc_Z1))
